...
wt.display_model(vmodel_inverted,extent=extent,title='Recovered model',filename=f"figs/fmm_{int(damping_factor)}_{int(flattening_factor)}_{int(smoothing_factor)}_simple_newton") # inverted model
