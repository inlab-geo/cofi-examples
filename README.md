...
[![CoFI docs](https://img.shields.io/badge/CoFI%20docs-Tutorials-99EDCC?style=flat-square&labelColor=f8f9fa&logo=readthedocs&logoColor=99EDCC)](https://cofi.readthedocs.io/en/latest/tutorials/generated/index.html)
...
Run through examples and have fun :tada:! We recommend opening up the [index.ipynb](index.ipynb) to decide where to start.
...
This project is distributed under a 2-clause BSD licence. A copy of this licence is accessible [here](LICENCE).
